...
public class ReservationVisitePortImpl implements ReservationVisiteSEI {
    ...
    public java.util.List<fr.eseo.javaee.projet.visiteguidee.Visite> trouverVisite(fr.eseo.javaee.projet.visiteguidee.Visite arg0) {
        ...
        try {
            ...
            _returnVal1.setCodeVisite(-1492622209);
            _returnVal1.setDateVisite(javax.xml.datatype.DatatypeFactory.newInstance().newXMLGregorianCalendar("2018-03-26T15:16:17.773+02:00"));
            _returnVal1.setPrix(0.032712996f);
            _returnVal1.setTypeDeVisite("TypeDeVisite1535345625");
            _returnVal1.setVille("Ville-1433512638");
    ...
    public fr.eseo.javaee.projet.visiteguidee.Client trouverClient(java.lang.String arg0, java.lang.String arg1) {
        ...
        try {
            ...
            _return.setAdresse("Adresse972839983");
            _return.setCodePostal(-805999561);
            _return.setIdClient(-741274917);
            _return.setMail("Mail417661266");
            _return.setNom("Nom-489984515");
            _return.setNumTelephone(854731330);
            _return.setPays("Pays-1347542541");
            _return.setPrenom("Prenom421090997");
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);

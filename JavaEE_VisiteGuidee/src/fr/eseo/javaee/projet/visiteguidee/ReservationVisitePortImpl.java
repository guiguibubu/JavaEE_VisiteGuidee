...
public class ReservationVisitePortImpl implements ReservationVisiteSEI {
    ...
    public java.util.List<fr.eseo.javaee.projet.visiteguidee.Visite> trouverVisite(fr.eseo.javaee.projet.visiteguidee.Visite arg0) {
        ...
        try {
            ...
            _returnVal1.setCodeVisite(1368937258);
            _returnVal1.setDateVisite(javax.xml.datatype.DatatypeFactory.newInstance().newXMLGregorianCalendar("2018-03-26T14:02:47.154+02:00"));
            _returnVal1.setPrix(0.44734263f);
            _returnVal1.setTypeDeVisite("TypeDeVisite-1469982200");
            _returnVal1.setVille("Ville-1475546969");

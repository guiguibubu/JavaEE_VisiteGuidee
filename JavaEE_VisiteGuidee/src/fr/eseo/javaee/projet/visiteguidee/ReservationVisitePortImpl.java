...
public class ReservationVisitePortImpl implements ReservationVisiteSEI {
     ...
     */
    public java.lang.String payerVisite(int arg0) throws SQLException_Exception {
        LOG.info("Executing operation payerVisite");
        System.out.println(arg0);
        try {
            java.lang.String _return = "_return-1478463531";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.util.List<fr.eseo.javaee.projet.visiteguidee.Visite> trouverVisite(fr.eseo.javaee.projet.visiteguidee.Visite arg0) throws SQLException_Exception {
        ...
        try {
            ...
            _returnVal1.setCodeVisite(518847256);
            ...
            _returnVal1.setPrix(0.3901986f);
            _returnVal1.setTypeDeVisite("TypeDeVisite2062587649");
            _returnVal1.setVille("Ville22012321");
